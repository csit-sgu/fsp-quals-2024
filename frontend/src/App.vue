...
import { Pagination, PaginationList, PaginationListItem, PaginationFirst, PaginationLast, PaginationNext, PaginationPrev, PaginationEllipsis } from '@/components/ui/pagination'
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
    ...
    <SidebarInset class="min-h-screen overflow-x-hidden">
      ...
      <Pagination :key="total" v-if="eventsWithCount.events.length > 0" v-slot="{ page }" :itemsPerPage="getPageSize()"
        ...
        <div class="pt-4 color-red-500 text-center">
          Всего найдено соревнований: {{ total }}
        </div>
